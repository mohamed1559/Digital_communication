...
rec_bit_seq = DecodeBitsFromSamples(rec_sample_seq,'part_1',p); % Decode the received bits
...
% Decode bits from received bit sequence
rec_bit_seq = DecodeBitsFromSamples(rec_sample_seq,'part_2',p,fs);   % Decode the received bits
